    ...
    <div class="min-h-screen">
        ...
        <section class="py-8 md:py-16 bg-gray-800">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <!-- Franchise Cards Grid - Адаптивная сетка: 1 колонка (mobile), 2 (tablet), 3 (desktop) -->
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 md:gap-6 mb-8 md:mb-12">
                    @forelse($featuredFranchises as $franchise)
                        <div class="bg-gray-900 rounded-xl shadow-xl border border-gray-700 hover:border-accent hover:shadow-2xl hover:shadow-orange-500/20 transition-all duration-300 transform hover:-translate-y-2 card-hover flex flex-col">
                            <!-- Image -->
                            <div class="relative h-48 md:h-56 bg-gray-200 rounded-t-xl overflow-hidden flex-shrink-0">
                            ...
                            <div class="p-4 md:p-5 flex flex-col flex-1">
                                <h3 class="text-lg md:text-xl font-black text-white mb-2 line-clamp-2">
                                    {{ $franchise->title }}
                                </h3>
                                ...
                                <div class="space-y-2 mb-4 bg-gray-800/50 p-3 rounded-lg border border-gray-700 flex-1">
                                    <div class="flex justify-between items-center">
                                        <span class="text-xs md:text-sm text-gray-400">Инвестиции:</span>
                                    ...
                                    <div class="flex justify-between items-center">
                                        <span class="text-xs md:text-sm text-gray-400">Роялти:</span>
                                ...
                                <!-- View Details Button -->
                                <a href="{{ route('franchises.show', $franchise) }}"
                                    class="block w-full text-center gradient-accent text-gray-900 py-2.5 md:py-3 rounded-lg font-bold text-sm md:text-base hover:shadow-lg hover:shadow-orange-500/50 transition-all duration-200">
                                    Подробнее
                                </a>
                            </div>
                        </div>
                    ...
                    @forelse($categories as $category)
                        <a href="{{ route('franchises.index', ['category' => $category->id]) }}"
                            ...
                            <div class="w-12 h-12 md:w-16 md:h-16 bg-accent/10 rounded-full flex items-center justify-center mx-auto mb-3 md:mb-4 group-hover:bg-accent/20 transition">
                                <i class="bi bi-shop text-accent text-xl md:text-2xl"></i>
                            </div>
