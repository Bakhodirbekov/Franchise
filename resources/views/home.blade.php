                ...
                <div class="text-center">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 justify-center">
                        <a href="{{ route('franchises.index') }}"
                            class="bg-white text-blue-600 px-8 py-4 rounded-xl font-bold text-lg hover:bg-blue-50 transition duration-200 shadow-lg">
                            Browse Franchises
                        </a>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
                    @forelse($featuredFranchises as $franchise)
                        <div
                            class="bg-white rounded-2xl shadow-lg border border-gray-200 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
                            <!-- Image -->
                            <div class="relative h-48 bg-gray-200 rounded-t-2xl overflow-hidden">
                            ...
                            <div class="p-6">
                                ...
                                <div class="flex space-x-3">
                                    <a href="{{ route('franchises.show', $franchise->slug) }}"
                                        class="flex-1 bg-gradient-to-r from-blue-500 to-purple-600 text-white text-center py-3 px-4 rounded-xl font-semibold hover:from-blue-600 hover:to-purple-700 transition duration-200">
                                        View Details
                                    </a>
                                    <button
                                        class="w-12 h-12 bg-gray-100 text-gray-700 rounded-xl hover:bg-gray-200 transition duration-200 flex items-center justify-center"
