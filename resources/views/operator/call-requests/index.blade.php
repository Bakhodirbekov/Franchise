...
@section('title', 'Call Requests - Operator Panel')
...
<div class="py-6">
    ...
    <div class="stat-card bg-white p-6 mb-6">
        <form method="GET" action="{{ route('operator.call-requests.index') }}" class="flex flex-col md:flex-row gap-4">
            <div class="flex-1">
            ...
            <div class="flex items-end">
                <div class="space-x-2">
                    ...
                    @if(request()->anyFilled(['start_date', 'end_date', 'status']))
                        <a href="{{ route('operator.call-requests.index') }}" class="btn-secondary">
                        ...
                        @forelse($callRequests as $request)
                            <tr class="hover:bg-gray-50 transition duration-150">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <form action="{{ route('operator.call-requests.update-status', $request) }}" method="POST" class="inline">
                                        @csrf
                                        @method('PUT')
