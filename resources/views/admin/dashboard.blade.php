...
<div class="py-6">
    ...
    <div class="mt-8">
        <div class="stat-card bg-white p-6">
            <div class="flex justify-between items-center mb-6">
                <div>
                    <h3 class="text-lg font-semibold text-gray-900">Contacted Clients</h3>
                    <p class="text-sm text-gray-600 mt-1">Clients operator has contacted - potential buyers</p>
                </div>
                <a href="{{ route('admin.inquiries.index') }}?status=contacted" class="text-sm text-blue-600 hover:text-blue-800">
                    View All
                </a>
            </div>
                ...
                <table class="w-full">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase">Investment Intent</th>
