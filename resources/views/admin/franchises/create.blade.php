...
@section('title', 'Create Franchise - Admin Panel')
...
<div class="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 py-8">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            ...
            <h1 class="text-3xl font-bold text-gray-900">Create New Franchise</h1>
            <p class="text-gray-600 mt-2">Add a new franchise opportunity to your catalog</p>
        </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div class="lg:col-span-2">
                        ...
                        <textarea name="short_description" 
                                  ...
                                  rows="3" 
                                  class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-200"
                                  placeholder="Brief description (max 255 characters)">{{ old('short_description') }}</textarea>
                        <p class="mt-1 text-sm text-gray-500">{{ Str::length(old('short_description', '')) }}/255 characters</p>
                    ...
                    <div class="lg:col-span-2">
                        ...
                        <textarea name="description" 
                                  ...
                                  rows="6" 
                                  class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-200"
                                  placeholder="Detailed description of the franchise opportunity">{{ old('description') }}</textarea>
                        @error('description')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="lg:col-span-2">
                        ...
                        <textarea name="requirements" 
                                  rows="4" 
                                  class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-200"
                                  placeholder="Enter requirements separated by commas&#10;Example: Business experience, Liquid capital, Management skills">{{ old('requirements') }}</textarea>
